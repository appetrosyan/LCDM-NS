...
\label{sec:org64dc6fa}
\subsubsection{Toy models}
\label{sec:orga5b11f6}
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{./illustrations/higson.pdf}
...
\section{Conclusions}
\label{sec:orgbee1414}

\subsection{Results}
\label{sec:orgaf7f9d9}
