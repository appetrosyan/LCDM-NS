...
\item \textbf{Representation}. In prior hyperspace
  ...
  some configurations of the re-parameterised prior represent the
  posterior. \label[Property]{spec-prop}
  
\item \textbf{Convergence}. The sampling favours configurations
  $\bm\hat{\theta} \in \Psi_{R}$. \label[Property]{vconv-prop}
\item \textbf{Objectivity}. The bias towards $\bm\hat{\theta}$ regions
  of large \( \hat{\cal P}(\bm{\hat{\theta}})\) is stronger than the
  bias towards \( \hat{\pi}
  (\bm{\hat{\theta}})\). \label[Property]{obj-prop}
\end{enumerate}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{./illustrations/SSIM_3d.pdf}
...
${\cal D}\{ \pi, {\cal P} \} \approx 0$.  \Cref{fig:kl-scaling}
