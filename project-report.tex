...
\begin{table}
  ...
  \begin{tabular}{lr}
    ...
    \hline
    \texttt{MultiNest} & \citep{Feroz2009MultiNestAE} \\
    \texttt{PolyChord} & \citep{polychord} \\
    \texttt{nestle} & \citep{nestle} \\
    \texttt{dyNesty} & \citep{Speagle_2020}
  \end{tabular}
...
e.g.~Metropolis-Hastings \cite{Metropolis-Hastings-Gibbs} is sensitive
...
\cite{code}. The posteriors of two runs with identical settings (save
...
such as reinforcement learning \cite{javid2020}. The process of
...
reinforced, and vice versa \cite{Kaelbling_1996}. This problem maps
...
This is related to the issue of discordant datasets \cite{tension},
...
for cosmological simulations can be found on Github \cite{sspr}. In a separate
repository is the version of Cobaya with our modifications, which is
able to support the options for stochastic mixing.
