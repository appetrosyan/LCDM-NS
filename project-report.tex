...
function} \(\pi\) or the \emph{cumulative distribution function} (CDF) \(\int
...
to the \emph{partitioning} of the \({\cal P}\) into \({\cal L}\) and
...
\label{sec:org58b0e86}
\subsubsection{Toy models}
\label{sec:org423a662}
...
\section{Conclusions}
\label{sec:orgdd5da8b}

\subsection{Results}
\label{sec:orge1cc862}
