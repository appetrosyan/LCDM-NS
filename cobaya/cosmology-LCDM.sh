...
#! Insert additional module load commandsafter this line if needed:
...
source /home/ap886/Cosmology/py38/bin/activate	   # Needed for Cobaya



#! Full path to application executable: 
application="/home/ap886/Cosmology/py38/bin/cobaya-run"

#! Run options for the application:
options="-m ./CobayaModules -r run.yaml"
